<module>
	...
	<setting_groups>
		...
		<name module_id="core" version_id="4.8.4" var_name="setting_group_emails">email</name>
        <!--new setting group in 4.8.6-->
        <name module_id="core" version_id="4.8.6" var_name="setting_group_regex">regex</name>
	</setting_groups>
	<settings>
...
Site Name</setting>
		...
		<setting group="registration" module_id="core" is_hidden="1" type="array" var_name="global_genders" phrase_var_name="setting_global_genders" ordering="1" version_id="2.0.5dev2"><![CDATA[s:112:"array(
  ...
  1 => '2|core.her|profile.female|core.herself|female',
        ...
        <!-- new setting in 4.8.2 -->
        <setting group="registration" module_id="core" is_hidden="0" type="boolean" var_name="enable_register_with_phone_number" phrase_var_name="setting_enable_register_with_phone_number" ordering="21" version_id="4.8.2">0</setting>
        <!-- new setting in 4.8.3 -->
        <setting group="site_offline_online" module_id="core" is_hidden="0" type="integer" var_name="site_offline_static_page" phrase_var_name="setting_site_offline_static_page" ordering="3" version_id="4.8.3">0</setting>
        <setting group="general" module_id="core" is_hidden="0" type="boolean" var_name="use_popup_on_signup_login_button" phrase_var_name="setting_use_popup_on_signup_login_button" ordering="16" version_id="4.8.3">1</setting>
        <setting group="time_stamps" module_id="core" is_hidden="0" type="select" var_name="pf_time_format" phrase_var_name="setting_core_pf_time_format" ordering="3" version_id="4.8.3"><![CDATA[a:2:{s:7:"default";i:2;s:6:"values";a:2:{i:1;s:14:"12-hour format";i:2;s:14:"24-hour format";}}]]></setting>
        <!-- new setting in 4.8.4 -->
        <setting group="registration" module_id="core" is_hidden="0" type="boolean" var_name="enable_register_with_google" phrase_var_name="setting_enable_register_with_google" ordering="22" version_id="4.8.4">0</setting>
        <setting group="registration" module_id="core" is_hidden="0" type="string" var_name="google_oauth_client_id" phrase_var_name="setting_google_oauth_client_id" ordering="23" version_id="4.8.4"/>
        <!--new setting in 4.8.6-->
        <setting group="seo" module_id="core" is_hidden="0" type="integer" var_name="max_character_length_for_description_meta" phrase_var_name="setting_max_character_length_for_description_meta" ordering="0" version_id="4.8.6">0</setting>
        <setting group="seo" module_id="core" is_hidden="0" type="integer" var_name="max_character_length_for_title_meta" phrase_var_name="setting_max_character_length_for_title_meta" ordering="0" version_id="4.8.6">0</setting>

        <setting group="regex" module_id="core" is_hidden="0" type="string" var_name="username_regex_rule" phrase_var_name="setting_username_regex_rule" ordering="0" version_id="4.8.6"><![CDATA[/^[a-zA-Z0-9_\-\x7f-\xff]{min,max}$/]]></setting>
        <setting group="regex" module_id="core" is_hidden="0" type="string" var_name="fullname_regex_rule" phrase_var_name="setting_fullname_regex_rule" ordering="1" version_id="4.8.6"><![CDATA[/^[^!@#$%^&*(),.?":{}|<>]{1,max}$/]]></setting>
        <setting group="regex" module_id="core" is_hidden="0" type="string" var_name="special_characters_regex_rule" phrase_var_name="setting_special_characters_regex_rule" ordering="2" version_id="4.8.6"><![CDATA[/[!@#$%^&*(),.?":{}|<>]/]]></setting>
        <setting group="regex" module_id="core" is_hidden="0" type="string" var_name="html_regex_rule" phrase_var_name="setting_html_regex_rule" ordering="3" version_id="4.8.6"><![CDATA[/<(.*?)>/]]></setting>
        <setting group="regex" module_id="core" is_hidden="0" type="string" var_name="url_regex_rule" phrase_var_name="setting_url_regex_rule" ordering="4" version_id="4.8.6"><![CDATA[~(?>[a-z+]{2,}://|www\.)(?:[a-z0-9]+(?:\.[a-z0-9]+)?@)?(?:(?:[a-z](?:[a-z0-9]|(?<!-)-)*[a-z0-9])(?:\.[a-z](?:[a-z0-9]|(?<!-)-)*[a-z0-9])+|(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?))(?:/[^\\/:?*"<>|\n]*[a-z0-9])*/?(?:\?[a-z0-9_.%]+(?:=[a-z0-9_.%:/+-]*)?(?:&[a-z0-9_.%]+(?:=[a-z0-9_.%:/+-]*)?)*)?(?:#[a-z0-9_%.]+)?~is]]></setting>
        <setting group="regex" module_id="core" is_hidden="0" type="string" var_name="currency_id_regex_rule" phrase_var_name="setting_currency_id_regex_rule" ordering="5" version_id="4.8.6"><![CDATA[/^[A-Z]{3,3}$/]]></setting>
    </settings>
	<blocks>
	...
	<crons>
		...
		<cron module_id="core" type_id="1" every="5" name="Add Queue Schedule Items"><![CDATA[Phpfox::getService('core.schedule')->addQueueScheduleItems();]]></cron>
	</crons>
	<pages>
