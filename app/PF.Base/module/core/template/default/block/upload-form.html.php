...
{/if}
            <div class="{if !empty($aUploadCallback.style)}{$aUploadCallback.style}-{/if}dropzone-component dont-unbind {if !empty($sDropzoneClass)}{$sDropzoneClass}{/if}" id="{$sType}-dropzone{if !empty($iId)}_{$iId}{/if}"
                 ...
                 data-item-id="{$iId}"
                 {if !empty($bForceConvertFile)}
                    data-force-convert-file="1"
                 {/if}
                 {if !empty($sParentElementId)}
                    data-parent-element-id="{$sParentElementId}"
                 {/if}
                 {if !empty($bKeepHiddenInput)}
                    data-keep-hidden-input="1"
                 {/if}
                 {if !empty($sHiddenInputName)}
                    data-hidden-input-name="{$sHiddenInputName}"
                 {/if}
                ...
                {/if}
                    ...
                    {plugin call='core.template_block_upload_form_dropzone_component'}
