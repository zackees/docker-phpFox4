    ...
    <div class="moderation_placeholder">
        ...
        <div class="btn-group btn-group-sm dropup moderation-dropdown hide" id="moderation_drop_down">
            ...
            <ul class="dropdown-menu dropdown-menu-right" id="moderation_menu">
                ...
                <li>
                    <a data-cmd="core.moderation_action" href="#{$aModerationMenu.action}" class="moderation_process_action" rel="{$aModerationParams.ajax}" {if !empty($aModerationMenu.message)}data-message="{$aModerationMenu.message}"{/if} {if !empty($aModerationParams.extra)}data-extra="{$aModerationParams.extra}"{/if}>{$aModerationMenu.phrase}</a>
                </li>
                {/foreach}
            </ul>
        </div>
