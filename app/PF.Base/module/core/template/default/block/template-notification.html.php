...
<nav class="pull-right">
    <ul class="list-inline header-right-menu">
        ...
        <li class="pl-0" id="hd-cof">
            ...
            {else}
            <ul class="dropdown-menu dropdown-menu-right dont-unbind">
                {if Phpfox::isAppActive('Core_Pages') && Phpfox::getUserParam('pages.can_view_browse_pages') && Phpfox::getUserParam('pages.can_add_new_pages')}
                <li>
                ...
                {if Phpfox::getParam('feed.enable_schedule_feed')}
                    <li role="presentation">
