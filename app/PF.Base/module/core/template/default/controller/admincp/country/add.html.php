    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control close_warning" name="val[country_iso]" value="{value id='country_iso' type='input'}"
                       size="4"/>
            </div>
            <div class="form-group">
                <label for="name" class="required">{_p var='name'}</label>
                <input type="text" class="form-control close_warning" name="val[name]" value="{value id='name' type='input'}" size="40"/>
            </div>
        </div>
