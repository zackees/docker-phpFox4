...
{else}
  ...
  {/if}
    ...
    {else}
      ...
      {if !PHPFOX_IS_AJAX && !defined('FEED_LOAD_NEW_FEEDS') && !defined('FEED_LOAD_MORE_NEWS') && !empty($iSponsorFeedId) && (!empty($aFeed.sponsored_feed) || $aFeed.feed_id == $iSponsorFeedId)}
        <div id="js_new_feed_comment"></div>
      {/if}
