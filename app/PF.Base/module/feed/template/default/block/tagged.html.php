    ...
    <div class="js_feed_compose_extra feed_compose_extra js_feed_compose_tagging dont-unbind-children" style="display: none;">
        <div class="feed-box">
            ...
            <div class="feed-tagging-input-box">
                <input type="hidden" class="close_warning" data-feedid="{if isset($iFeedId)}{$iFeedId}{else}0{/if}" id="feed_input_tagged{if isset($iFeedId)}_{$iFeedId}{else}_0{/if}" name="val[tagged_friends]" value="{if isset($aForms.tagged_friends)}{$aForms.tagged_friends}{/if}">
