<module>
	...
	<settings>
        ...
        <setting group="" module_id="feed" is_hidden="0" type="boolean" var_name="enable_hide_feed" phrase_var_name="setting_enable_hide_feed" ordering="1" version_id="4.7.7">1</setting>
        ...
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_subject_comment_on_own_post_on_other_wall" phrase_var_name="setting_feed_setting_subject_comment_on_own_post_on_other_wall" ordering="1" version_id="4.8.4"><![CDATA[{_p var="full_name_commented_on_one_of_gender_wall_comments"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_content_comment_on_own_post_on_other_wall" phrase_var_name="setting_feed_setting_content_comment_on_own_post_on_other_wall" ordering="2" version_id="4.8.4"><![CDATA[{_p var="full_name_commented_on_one_of_gender_wall_comments_message"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_subject_comment_on_post_on_other_wall" phrase_var_name="setting_feed_setting_subject_comment_on_post_on_other_wall" ordering="3" version_id="4.8.4"><![CDATA[{_p var="full_name_commented_on_one_of_row_full_name_s_wall_comments"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_content_comment_on_post_on_other_wall" phrase_var_name="setting_feed_setting_content_comment_on_post_on_other_wall" ordering="4" version_id="4.8.4"><![CDATA[{_p var="full_name_commented_on_one_of_row_full_name_s_wall_comments_message"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_subject_comment_on_post_on_your_wall" phrase_var_name="setting_feed_setting_subject_comment_on_post_on_your_wall" ordering="5" version_id="4.8.4"><![CDATA[{_p var="full_name_commented_on_one_of_your_wall_comments"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_content_comment_on_post_on_your_wall" phrase_var_name="setting_feed_setting_content_comment_on_post_on_your_wall" ordering="6" version_id="4.8.4"><![CDATA[{_p var="full_name_commented_on_one_of_your_wall_comments_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_subject_like_your_post_on_other_wall" phrase_var_name="setting_feed_setting_subject_like_your_post_on_other_wall" ordering="7" version_id="4.8.4"><![CDATA[{_p var="full_name_liked_a_comment_you_posted_on_row_full_name_s_wall"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_content_like_your_post_on_other_wall" phrase_var_name="setting_feed_setting_content_like_your_post_on_other_wall" ordering="8" version_id="4.8.4"><![CDATA[{_p var="full_name_liked_your_comment_message"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_subject_like_your_comments" phrase_var_name="setting_feed_setting_subject_like_your_comments" ordering="9" version_id="4.8.4"><![CDATA[{_p var="full_name_liked_one_of_your_comments"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_content_like_your_comments" phrase_var_name="setting_feed_setting_content_like_your_comments" ordering="10" version_id="4.8.4"><![CDATA[{_p var="full_name_liked_your_comment_message_mini"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_subject_other_post_on_your_wall" phrase_var_name="setting_feed_setting_subject_other_post_on_your_wall" ordering="11" version_id="4.8.4"><![CDATA[{_p var="full_name_wrote_a_comment_on_your_wall"}]]></setting>
        <setting group="email" module_id="feed" is_hidden="0" type="" var_name="feed_setting_content_other_post_on_your_wall" phrase_var_name="setting_feed_setting_content_other_post_on_your_wall" ordering="12" version_id="4.8.4"><![CDATA[{_p var="full_name_wrote_a_comment_on_your_wall_message"}]]></setting>
        <!-- new setting in 4.8.9 -->
        <setting group="" module_id="feed" is_hidden="0" type="boolean" var_name="enable_schedule_feed" phrase_var_name="setting_enable_schedule_feed" ordering="1" version_id="4.8.9">1</setting>
	</settings>
	<blocks>
