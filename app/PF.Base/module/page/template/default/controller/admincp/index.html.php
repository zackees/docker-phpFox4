        ...
        <table class="table table-admin">
            ...
            <tbody>
                ...
                <tr class="checkRow{if is_int($iKey/2)} tr{else}{/if}">
                    ...
                    <td><a href="{url link=$aPage.title_url}" class="targetBlank {if !$aPage.is_active}inactive_page{/if}" {if !$aPage.is_active} title="{_p var='inactive_page'}"{/if}>{if $aPage.is_phrase}{_p var=$aPage.title}{else}{$aPage.title|clean}{/if}</a></td>
                    <td>
