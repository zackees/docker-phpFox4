...
class User_Service_Space extends Phpfox_Service
{
    ...
    public function isAllowedToUpload($iUserId, $iUploaded = null)
    {
        ...
        if ($this->_iTotalSpaceUsed >= $this->_iTotalUploadSpace) {
            return Phpfox_Error::set(_p('unable_to_upload_you_have_reached_your_limit_of_current_you_are_currently_using_total', [
        ...
        if ($iUploaded !== null && ($this->_iTotalSpaceUsed + $iUploaded) > $this->_iTotalUploadSpace) {
            return Phpfox_Error::set(_p('unable_to_upload_you_have_reached_your_limit_of_limit_with_this_upload_you_will_be_using_total', [
    ...
    private function _build($iUserId)
    {
        ...
        if ($mIsChecked === null) {
            ...
            if ($iUserGroupId) {
                ...
                if($this->_iTotalSpaceUsed > $this->_iTotalUploadSpace) {
                    $this->_iTotalSpaceUsed = $this->_iTotalUploadSpace;
                }
            }
