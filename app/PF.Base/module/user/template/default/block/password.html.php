...
<form method="post" class="form" action="{url link='current'}" onsubmit="$(this).ajaxCall('user.updatePassword'); return false;" id="js_change_password_form">
    {if empty($bPassOld) || !$bPassOld}
        <div class="form-group">
            <label for="old_password">{_p var='current_password'}</label>
