...
class Share_Component_Block_Addthis extends Phpfox_Component
{
	...
	public function process()
	{
	    ...
	    $sAddthisTitle = Phpfox::getLib('parse.output')->cleanPhrases($this->getParam('title', ''));
	    $sAddthisDesc = Phpfox::getLib('parse.output')->cleanPhrases($this->getParam('description', ''));
