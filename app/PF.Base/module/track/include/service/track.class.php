 ...
 * @version 		$Id: track.class.php 5914 2013-05-13 08:38:15Z phpFox LLC $
 */
...
{	
	...
	{			
		return Phpfox::hasCallback($sType, 'getLatestTrackUsers') ? Phpfox::callback($sType . '.getLatestTrackUsers', $iId, $iUserId) : null;
	}
