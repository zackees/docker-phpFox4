...
<div class="form-group">
    ...
    <div class="item_is_active_holder">
        <span class="js_item_active item_is_active hide" onclick="$('#showBanForm').hide();">
            <input type="radio" name="aBan[bShow]" value="1" {value type='radio' id='is_active' default='1'}/>
        </span>
        <span class="js_item_active item_is_not_active hide" onclick="$('#showBanForm').show();">
...
{/if}
	...
	<div class="form-group" {if isset($bHideAffected) && $bHideAffected == true}style="display:none;"{/if}>
		<label>{_p var='user_group_affected'}</label>
        {foreach from=$aUserGroups item=aGroup}
        <div class="checkbox">
