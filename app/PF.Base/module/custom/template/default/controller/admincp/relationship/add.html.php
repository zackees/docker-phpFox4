    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                {if isset($aEdit)}
                {module name='language.admincp.form' type='text' id='new' var_name=$aEdit.phrase.new close_warning=1}
                {else}
                {module name='language.admincp.form' type='text' id='new' close_warning=1}
                {/if}
                <p class="help-block">
            ...
            <div class="form-group">
                ...
                {if isset($aEdit)}
                {module name='language.admincp.form' type='text' id='feed_with' var_name=$aEdit.phrase.feed_with close_warning=1}
                {else}
                {module name='language.admincp.form' type='text' id='feed_with' close_warning=1}
                {/if}
                <p class="help-block">
            ...
            <div class="form-group">
                ...
                {if isset($aEdit)}
                {module name='language.admincp.form' type='text' id='feed_new' var_name=$aEdit.phrase.feed_new close_warning=1}
                {else}
                {module name='language.admincp.form' type='text' id='feed_new' close_warning=1}
                {/if}
                <p class="help-block">
            ...
            <div class="form-group">
                ...
                <div class="custom-checkbox-wrapper">
                    <label>
                        <input type="checkbox" class="close_warning" name="val[confirmation]" {if isset($aEdit) && $aEdit.confirmation == 1}checked="checked" {/if}>
            ...
            <div class="form-group">
                <p class="help-block">
                    ...
                    <br />{l}their{r} {_p var='sender_s_possessive_adjective_their'}
                </p>
            </div>
        </div>
