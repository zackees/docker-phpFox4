        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="button" value="{_p var='cancel_uppercase'}" class="btn btn-default" id="js_cancel_new_group" />
                </div>
            </div>
        </div>
...
<div id="js_field_holder">
	...
	<form class="form" method="post" action="{url link='admincp.custom.add'}" id="js_custom_field" onsubmit="{$sCustomGetJsForm}">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panel-title">{_p var='custom_field_details'}</div>
            </div>
            <div class="panel-body">
                <div {if $bIsEdit} style="display:none;"{/if} >
                    {module name='admincp.product.form' class=true}
                ...
                <div class="form-group js_core_init_selectize_form_group">
                    ...
                    <div class="form-group">
                        <select name="val[group_id]" id="js_group_listing" class="form-control">
                            ...
                            <option value="{$aGroup.group_id}"{value type='select' id='group_id' default=$aGroup.group_id}>{$aGroup.phrase_var_name_text}</option>
                            {/foreach}
                        </select>
                ...
                <div class="form-group js_core_init_selectize_form_group"{if $bIsEdit} style="display:none;"{/if}>
                    ...
                    <select id="var_type" name="val[var_type]" class="var_type form-control" required>
                        ...
                        <option value="date"{value type='select' id='var_type' default='date'}>{_p var='date'}</option>
                    </select>
                </div>
                <div class="form-group">
