...
<form class="form" method="post" action="{url link='admincp.language.add'}" enctype="multipart/form-data">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <select name="val[parent_id]" class="form-control close_warning" id="parent_id" autofocus>
            ...
            <div class="form-group">
                ...
                <input type="text" name="val[title]" id="title" value="{value type='input' id='title'}" size="40" class="form-control close_warning"/>
            </div>
            <div class="form-group">
                <label for="language_code">{required}{_p var='language_abbreviation_code'}</label>
                <input type="text" name="val[language_code]" id="language_code" value="{value type='input' id='language_code'}" size="5" maxlength="5" class="form-control close_warning"/>
            </div>
            <div class="form-group">
                <label for="direction">{required}{_p var='text_direction'}</label>
                <div class="custom-radio-wrapper">
                    <label>
                        <input type="radio" name="val[direction]" value="ltr" {value type='radio' id='direction' default='ltr' selected=true} class="close_warning"/>
                        <span class="custom-radio"></span>
                        {_p var='left_to_right'}
                    </label> <br/>
                    <label>
                        <input type="radio" name="val[direction]" value="rtl" {value type='radio' id='direction' default='rtl'} class="close_warning"/>
                        <span class="custom-radio"></span>
                ...
                <div class="table_right">
                    <div class="item_is_active_holder">
                        <span class="js_item_active item_is_active">
                            <input type="radio" name="val[user_select]" value="1" {value type='radio' id='user_select' default='1' selected='true'} class="close_warning"/>
                        </span>
                        <span class="js_item_active item_is_not_active">
                            <input type="radio" name="val[user_select]" value="0" {value type='radio' id='user_select' default='0'} class="close_warning"/>
                        </span>
                    </div>
                </div>
                <div class="clear"></div>
            ...
            <div class="table form-group">
                ...
                <div class="table_right">
                    ...
                    <div id="js_current_image">
                        <img src="{$aForms.image}" alt="" class="v_middle" width="32px"/>
                        - <a href="#" onclick="$('#js_current_image').hide(); $('#js_upload_new_icon').show();">{_p var='change_icon'}</a>
                    </div>
                    {/if}
                    <div id="js_upload_new_icon" {if $bIsEdit && !empty($aForms.image)} style="display:none;" {
                    /if}>
                    <input type="file" name="icon" size="30" class="close_warning"/>
                    {if $bIsEdit}
    ...
    <div class="form-group">
        ...
        <input type="text" name="val[version]" id="version" value="{value type='input' id='version'}" class="form-control close_warning"/>
    </div>
    <div class="form-group">
        <label for="store_id">{_p var='store_id'} ({_p var="for developer only"})</label>
        <input type="text" name="val[store_id]" id="store_id" value="{value type='input' id='store_id'}" class="form-control close_warning"/>
    </div>
