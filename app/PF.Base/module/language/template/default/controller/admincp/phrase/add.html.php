            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="custom-radio-wrapper">
                        <label for="quick_add_input" class="radio-inline" onclick="$('#detail_add').removeClass('in');$('#quick_add').addClass('in');">
                            <input data-toggle="pf-panel" data-cmd="check_box_hide" data-show="class_quick_add" href="#quick_add" type="radio" id="quick_add_input" value="1" name="val[type]" checked="checked" class="close_warning"/>
                            <span class="custom-radio"></span>
                            {_p var='Quick'}
                        </label>
                        <label class="radio-inline" onclick="$('#detail_add').addClass('in');$('#quick_add').removeClass('in');" for="detail_add_input">
                            <input data-toggle="pf-panel" data-cmd="check_box_hide" href="#detail_add" data-show="class_detail_add" type="radio" id="detail_add_input" value="2" name="val[type]" class="close_warning">
                            <span class="custom-radio"></span>
                            {_p var="Detail"}
                        </label>
                    </div>
                ...
                <div id="quick_add" class="panel-collapse collapse in check_box_hide class_quick_add">
                    <div class="form-group">
                        ...
                        <input type="text" name="val[phrase]" value="" size="40" id="var_name" class="form-control close_warning" autofocus/>
                    </div>
                </div>
                <div id="detail_add" class="panel-collapse collapse check_box_hide class_detail_add">
                    <div class="form-group">
                        <label for="var_name">{_p var='varname'}</label>
                        <input type="text" name="val[var_name]" value="{$sVar}" size="40" id="var_name" maxlength="100" class="form-control close_warning" autofocus/>
