<module>
	...
	<settings>
        ...
        <setting group="" module_id="friend" is_hidden="0" type="drop" var_name="friendship_direction" phrase_var_name="setting_friendship_direction" ordering="1" version_id="4.7.8"><![CDATA[a:2:{s:7:"default";s:19:"two_way_friendships";s:6:"values";a:2:{i:0;s:19:"two_way_friendships";i:1;s:19:"one_way_friendships";}}]]></setting>
        <setting group="" module_id="friend" is_hidden="0" type="boolean" var_name="friend_allow_posting_on_main_feed" phrase_var_name="setting_friend_allow_posting_on_main_feed" ordering="1" version_id="4.7.8">1</setting>
        ...
        <setting group="email" module_id="friend" is_hidden="0" type="" var_name="friend_setting_subject_sent_friend_request" phrase_var_name="setting_friend_setting_subject_sent_friend_request" ordering="1" version_id="4.8.4"><![CDATA[{_p var="full_name_added_you_as_a_friend_on_site_title"}]]></setting>
        <setting group="email" module_id="friend" is_hidden="0" type="" var_name="friend_setting_content_sent_friend_request" phrase_var_name="setting_friend_setting_content_sent_friend_request" ordering="2" version_id="4.8.4"><![CDATA[{_p var="full_name_added_you_as_a_friend_on_site_title_to_confirm_this_friend_request"}]]></setting>
        <setting group="email" module_id="friend" is_hidden="0" type="" var_name="friend_setting_subject_added_as_friend" phrase_var_name="setting_friend_setting_subject_added_as_friend" ordering="3" version_id="4.8.4"><![CDATA[{_p var="full_name_added_you_as_a_friend_on_site_title"}]]></setting>
        <setting group="email" module_id="friend" is_hidden="0" type="" var_name="friend_setting_content_added_as_friend" phrase_var_name="setting_friend_setting_content_added_as_friend" ordering="4" version_id="4.8.4"><![CDATA[{_p var="full_name_added_you_as_a_friend_on_site_title_to_view_the_profile_of_this_friend_follow_the_link_below_link"}]]></setting>
        <setting group="email" module_id="friend" is_hidden="0" type="" var_name="friend_setting_subject_confirmed_friend_request" phrase_var_name="setting_friend_setting_subject_confirmed_friend_request" ordering="5" version_id="4.8.4"><![CDATA[{_p var="full_name_confirmed_you_as_a_friend_on_site_title"}]]></setting>
        <setting group="email" module_id="friend" is_hidden="0" type="" var_name="friend_setting_content_confirmed_friend_request" phrase_var_name="setting_friend_setting_content_confirmed_friend_request" ordering="6" version_id="4.8.4"><![CDATA[{_p var="full_name_confirmed_you_as_a_friend_on_site_title_to_view_their_profile"}]]></setting>
	</settings>
	<blocks>
