...
class Friend_Component_Block_Browse_Online extends Phpfox_Component
{
    ...
    public function process()
    {
        ...
        (($sPlugin = Phpfox_Plugin::get('friend.component_block_browse_online_process_start')) ? eval($sPlugin) : false);
    ...
    {
        (($sPlugin = Phpfox_Plugin::get('friend.component_block_browse_online_clean')) ? eval($sPlugin) : false);
    }
}
