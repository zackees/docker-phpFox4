...
<div id="js_friend_loader">
    {if $sFriendType != 'mail'}
        ...
        {/if}
            ...
            {else}
            <input type="text" class="js_is_enter v_middle default_value" name="find" placeholder="{_p var='search_by_email_phone_number_full_name_or_user_name'}" id="js_find_friend" autocomplete="off" size="30" />
            {/if}
        {if !$bInForm}
        </form>
        {/if}
    {else}
        ...
        {else}
            <input type="text" class="js_is_enter v_middle default_value" name="find" value="{_p var='search_by_email_phone_number_full_name_or_user_name'}" id="js_find_friend" autocomplete="off" size="30" />
        {/if}
            ...
            <div class="item-outer">
                <div class="moderation_row">
                    <label class="item-checkbox">
                        <input type="checkbox" class="js_global_item_moderate {if !empty($bCloseWarning)}close_warning{/if}" name="friend[]" value="{$aFriend.user_id}"
                ...
                <div class="user_rows">
                    <div class="user_rows_image">
                        {img user=$aFriend suffix='_120_square' max_width=32 max_height=32 no_link=true style="vertical-align:middle;"}
                    </div>
