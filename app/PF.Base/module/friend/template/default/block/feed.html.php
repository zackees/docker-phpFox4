 ...
 * @version 		$Id: top.html.php 1135 2009-10-05 12:59:10Z phpFox LLC $
 */
...
{if Phpfox::getService('user.privacy')->hasAccess('' . $aUserFriendFeed.user_id . '', 'profile.view_location') && (!empty($aUserFriendFeed.city_location) || !empty($aUserFriendFeed.country_child_id) || !empty($aUserFriendFeed.location))}
    <div class="extra_info">
        ...
        <span>
            ...
            {if !empty($aUserFriendFeed.country_child_id)}&nbsp;{$aUserFriendFeed.country_child_id|location_child},{/if}
            {if !empty($aUserFriendFeed.location)}&nbsp;{$aUserFriendFeed.location}{/if}
        </span>
    </div>
{/if}
