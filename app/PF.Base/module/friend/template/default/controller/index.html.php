	...
	<div class="item_bar">
		<div class="item_bar_action_holder">
			...
			<ul class="dropdown-menu dropdown-menu-right">
				<li class="item_delete"><a href="{url link='friend' dlist=$iList}" class="friend_list_delete sJsConfirm" data-message="{_p var='are_you_sure_you_want_to_delete_this_list_permanently' phpfox_squote=true}">{_p var='delete_list'}</a></li>
