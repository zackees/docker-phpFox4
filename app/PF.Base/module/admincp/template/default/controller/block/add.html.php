...
{literal}
    <script type="text/javascript">
        ...
        function changeController(oObj) {
          let _this = $(oObj),
            currentController = _this.val();
          $.ajaxCall('admincp.getComponentsForController', $.param({
            controller: typeof currentController === "undefined" ? '' : currentController,
          }));
          return false;
        }
    </script>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group js_core_init_selectize_form_group">
            ...
            <select name="val[m_connection]" id="m_connection" class="form-control" onchange="return changeController(this);">
                ...
                <optgroup label="{$sName|translate:'module'}">
                    ...
                    <option value="{$aCont.m_connection}"{value type='select' id='m_connection' default=$aCont.m_connection}>
                        {if isset($aCont.title)}
                        {$aCont.title}
                        {else}
                        {_p var='controller_'$aCont.m_connection}
                        {/if}
                        ({$aCont.m_connection})
                    </option>
                    {/foreach}
        ...
        <div class="form-group js_core_init_selectize_form_group js_block_type js_block_type_id_0 {if $bIsEdit && $aForms.type_id > 0}hide{/if}">
            ...
            <select name="val[component]" id="component" class="form-control">
                {template file='admincp.block.block.component-options'}
            </select>
