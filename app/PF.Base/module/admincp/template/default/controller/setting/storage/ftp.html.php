...
{/if}
{$sCreateJs}
<form method="post" onsubmit="{$sGetJsForm}" class="form" action="{url link='current'}" id="js_storage_ftp_form">
<!--    <p>{_p var='storage_ftp_form_description'}</p>-->
    ...
    <div id="client_details" class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="val[host]" id="host" value="{value type='input' id='host'}" size="30"/>
                <p class="help-text"></p>
            </div>
            <div class="form-group">
                ...
                <p class="help-block">{_p var='example'}: 21</p>
            </div>
            <div class="form-group">
