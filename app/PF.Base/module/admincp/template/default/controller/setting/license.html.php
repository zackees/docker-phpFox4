        ...
        <div id="client_details" class="panel panel-default">
            ...
            <div class="panel-body"><div><input type="hidden" id="license_trial" name="val[is_trial]" value="0"></div>
                ...
                <div class="form-group">
                    ...
                    <input required class="form-control" autocomplete="off" type="password" name="val[license_key]" id="license_key" value="{$aVals.license_key}" size="30" placeholder="{_p var='License Key'}" />
                </div>
                <div class="form-group">
