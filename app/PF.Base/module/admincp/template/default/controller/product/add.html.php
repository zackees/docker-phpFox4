                ...
                <tr class="checkRow{if is_int($iKey/2)} tr{else}{/if}">
                    ...
                    <td style="text-align:center;">
                        <div class="custom-checkbox-wrapper">
                            <label>
                                <input type="checkbox" name="val[dependency][delete][]" class="checkbox" value="{$aDependency.dependency_id}" id="js_id_row{$aDependency.dependency_id}" />
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="custom-radio-wrapper">
                    <label>
                        <input type="radio" name="val[dependency][type_id]" value="php" /> {_p var='php'}
                        <span class="custom-radio"></span>
                    </label>
                </div>
                <div style="padding-top:5px;" class="custom-radio-wrapper">
                    <label>
                        <input type="radio" name="val[dependency][type_id]" value="phpfox" />
                        <span class="custom-radio"></span>
                        {_p var='phpfox_version'}
                    </label>
                </div>
                <div style="padding-top:5px;" class="custom-radio-wrapper">
                    <label>
                        <input type="radio" name="val[dependency][type_id]" value="product" />
                        <span class="custom-radio"></span>
                        {_p var='product_id'}
                    </label>
                    <input class="form-control" type="text" name="val[dependency][check_id]" value="" />
                </div>
            </div>
            <div class="form-group">
                    ...
                    <tbody>
                        ...
                        <tr class="checkRow{if is_int($iKey/2)} tr{else}{/if}">
                            ...
                            <td style="text-align:center;">
                                <div class="custom-checkbox-wrapper">
                                    <label>
                                        <input type="checkbox" name="val[install][delete][]" class="checkbox" value="{$aInstall.install_id}" id="js_id_row{$aInstall.install_id}" />
                                        <span class="custom-checkbox"></span>
                                    </label>
                                </div>
                            </td>
