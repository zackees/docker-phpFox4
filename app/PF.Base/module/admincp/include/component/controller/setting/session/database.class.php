...
/**
 * Class Admincp_Component_Controller_Setting_Session_Database
 * @since 4.8.0
 * @author phpfox
 */
class Admincp_Component_Controller_Setting_Session_Database extends Phpfox_Component
{
	...
	public function process()
	{
		...
		$this->template()->clearBreadCrumb()
			...
			->assign([
				'aForms' => $aVals,
				'sError' => $sError,
				'sSessionTable' => Phpfox::getT('core_session_data'),
			]);
	}
}