...
/**
 * Class Admincp_Component_Controller_Setting_Storage_Sftp
 * @since 4.8.0
 * @author phpfox
 */
class Admincp_Component_Controller_Setting_Storage_Sftp extends Phpfox_Component
{
	const SERVICE_ID = 'sftp';
	...
	public function process()
	{
        ...
        $oValid = Phpfox::getLib('validator')->set(array(
                'sFormName' => 'js_storage_sftp_form',
                'aParams' => $aValidation
            )
        );
		...
		$this->template()
			->setTitle(_p('sftp_storage'))
			->setBreadCrumb(_p('sftp_storage'))
