...
/**
 * Class Admincp_Component_Controller_Setting_Session_Memcached
 * @since 4.8.0
 * @author phpfox
 */
class Admincp_Component_Controller_Setting_Session_Memcached extends Phpfox_Component
{
	const SERVICE_ID = 'memcached';
