...
/**
 * Class Admincp_Component_Controller_Setting_Queue_Sqs
 * @since 4.8.0
 * @author phpfox
 */
class Admincp_Component_Controller_Setting_Queue_Sqs extends Phpfox_Component
{
	const SERVICE_ID = 'amazon-sqs';
