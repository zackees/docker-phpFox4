<?php
/** $Id: country.xml.php 2525 2011-04-13 18:03:20Z phpFox LLC $ **/
...
<countries>
	...
	<country iso="FK" name="Falkland Islands (Malvinas)" />
	...
	<country iso="TF" name="French Southern Territories" />
	...
	<country iso="HM" name="Heard Island and Mcdonald Islands" />
	<country iso="VA" name="Holy See (Vatican City State)" />
	...
	<country iso="IR" name="Iran, Islamic Republic of" />
	...
	<country iso="FM" name="Micronesia, Federated States of" />
	<country iso="MD" name="Moldova, Republic of" />
	...
	<country iso="PS" name="Palestinian Territory, Occupied" />
	...
	<country iso="SJ" name="Svalbard and Jan Mayen" />
	<country iso="SZ" name="Swaziland" />
	<country iso="SE" name="Sweden" />
	<country iso="CH" name="Switzerland" />
	<country iso="SY" name="Syrian Arab Republic" />
	<country iso="TW" name="Taiwan, Province of China" />
	<country iso="TJ" name="Tajikistan" />
	<country iso="TZ" name="Tanzania, United Republic of" />
	<country iso="TH" name="Thailand" />
	<country iso="TL" name="Timor-Leste" />
	...
	<country iso="UM" name="United States Minor Outlying Islands" />
	<country iso="UY" name="Uruguay" />
	<country iso="UZ" name="Uzbekistan" />
	<country iso="VU" name="Vanuatu" />
	<country iso="VE" name="Venezuela" />
	<country iso="VN" name="Viet Nam" />
	<country iso="VG" name="Virgin Islands, British" />
	<country iso="VI" name="Virgin Islands, U.s." />
	<country iso="WF" name="Wallis and Futuna" />
	<country iso="EH" name="Western Sahara" />
