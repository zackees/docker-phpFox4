...
class Field
{
    ...
    /**
     * @var string This attribute determine which column that this field will be renamed to
     */
    private $_rename_from_column = '';
    ...
    public function __construct($aParam = [])
    {
        ...
        if (isset($aParam['rename_from'])) {
            $this->_rename_from_column = $aParam['rename_from'];
        }
    }
    ...
    {
        return $this->_rename_from_column;
    }
